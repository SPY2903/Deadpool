...
public class ComboHandTwoState : IState
{
    private PlayerController playerController;
    private bool isAnimationPlaying;
    private bool wasClickPreviousFrame;
    public ComboHandTwoState(PlayerController playerController)
    {
    ...
    public void Enter()
    {
        ...
        playerController.PlayerAnimator.CrossFade("Combo Hand 2", .25f);
    ...
    public void Update()
    {
        ...
        if (isAnimationPlaying && stateInfo.normalizedTime >= 1.0f && !playerController.PlayerAnimator.IsInTransition(0))
        {
            ...
            {
                playerController.PlayerStateMachine.TransitionTo(playerController.PlayerStateMachine.comboHandThreeState);
            }
            else
            {
