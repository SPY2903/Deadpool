...
public class ComboHandThreeState : IState
{
    private PlayerController playerController;
    private bool isAnimationPlaying;
    public ComboHandThreeState(PlayerController playerController)
    {
    ...
    public void Enter()
    {
        ...
        playerController.PlayerAnimator.CrossFade("Combo Hand 3", .25f);
