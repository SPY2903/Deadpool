...
public class ComboSwordOneState : IState
{
    private PlayerController playerController;
    private bool isAnimationPlaying;
    private bool wasClickPreviousFrame;
    public ComboSwordOneState(PlayerController playerController)
    {
    ...
    public void Enter()
    {
        ...
        playerController.PlayerAnimator.CrossFade("Combo Sword 1", .25f);
    ...
    public void Update()
    {
        ...
        if (isAnimationPlaying && stateInfo.normalizedTime >= 1.0f && !playerController.PlayerAnimator.IsInTransition(0))
        {
            ...
            {
                playerController.PlayerStateMachine.TransitionTo(playerController.PlayerStateMachine.comboSwordTwoState);
            }
            else
            {
