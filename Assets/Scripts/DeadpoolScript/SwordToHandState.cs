...
public class SwordToHandState : IState
{
    private PlayerController playerController;
    private bool isAnimationPlaying;
    public SwordToHandState(PlayerController playerController)
    {
    ...
    public void Enter()
    {
        ...
        playerController.PlayerAnimator.CrossFade("Sword to hand", .1f);
    }
    public void Update()
    {
